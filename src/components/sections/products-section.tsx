      ...
      <div className="container px-4 md:px-6">
        <div className={`mb-10 ${isInView ? "animate-fade-up" : "opacity-0"}`}>
          ...
          <p className="mt-2 text-gray-700 md:text-lg">
            At Chemodose Pharmaceuticals, we offer a wide range of high-quality, safe, and affordable pharmaceutical
            products to meet the needs of healthcare providers across Ethiopia. Our selection includes:
          </p>
        </div>
