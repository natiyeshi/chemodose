...
import { ArrowRight, ShieldCheck, Pill, Stethoscope, Microscope } from "lucide-react"
...
const benefits = [
  {
    ...
    description: "All our products meet international quality standards and are sourced from reputable manufacturers.",
    icon: ShieldCheck,
  },
  {
    title: "Comprehensive Range",
    description: "We offer a wide range of pharmaceutical products to meet diverse healthcare needs.",
    icon: Pill,
  },
  {
    title: "Healthcare Support",
    description: "Our team provides expert guidance on product selection and usage for optimal patient outcomes.",
    icon: Stethoscope,
  },
  {
    title: "Research-Backed",
    description: "Our products are backed by scientific research and clinical evidence for efficacy and safety.",
    icon: Microscope,
  },
]
      ...
      <main className="flex-1">
        <section className="relative overflow-hidden bg-[#0a3141] py-16 md:py-24" ref={headerRef}>
          ...
          <div className="container relative px-4 md:px-6">
            <div className="text-center">
              ...
              >
                Delivering high-quality, affordable pharmaceutical products to healthcare providers across Ethiopia
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 md:py-24" ref={featuredRef}>
          <div className="container px-4 md:px-6">
            <div className={`mb-12 text-center ${featuredInView ? "animate-fade-up" : "opacity-0"}`}>
              <h2 className="text-3xl font-bold">Featured Products</h2>
              <p className="mt-4 text-gray-700 md:text-lg max-w-3xl mx-auto">
                Explore our selection of high-quality pharmaceutical products that meet international standards
              </p>
            </div>
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {products
                ...
                .map((product, index) => (
                  <Card
                    key={product.id}
                    className={`overflow-hidden border-0 shadow-md hover:shadow-lg transition-all duration-300 hover:translate-y-[-5px] ${featuredInView ? "animate-fade-up" : "opacity-0"}`}
                    style={{ animationDelay: featuredInView ? `${index * 100 + 200}ms` : "0ms" }}
                  >
                    <div className="relative aspect-square w-full overflow-hidden bg-gray-100">
                      ...
                      />
                      <Badge className="absolute right-2 top-2 bg-teal-500 hover:bg-teal-600">Featured</Badge>
                    </div>
        ...
        <section className="py-16 md:py-24 bg-gray-50" ref={categoriesRef}>
          <div className="container px-4 md:px-6">
            <div className={`mb-12 text-center ${categoriesInView ? "animate-fade-up" : "opacity-0"}`}>
              <h2 className="text-3xl font-bold">Product Categories</h2>
              <p className="mt-4 text-gray-700 md:text-lg max-w-3xl mx-auto">
                Browse our comprehensive range of pharmaceutical products by category
              </p>
            </div>

            <Tabs
              defaultValue="all"
              className={`w-full ${categoriesInView ? "animate-fade-up" : "opacity-0"}`}
        ...
        <section className="py-16 md:py-24" ref={benefitsRef}>
          <div className="container px-4 md:px-6">
            <div className={`mb-12 text-center ${benefitsInView ? "animate-fade-up" : "opacity-0"}`}>
              <h2 className="text-3xl font-bold">Why Choose Our Products?</h2>
              <p className="mt-4 text-gray-700 md:text-lg max-w-3xl mx-auto">
                At Chemodose Pharmaceuticals, we are committed to providing the highest quality pharmaceutical products
              </p>
            </div>
            ...
            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
              {benefits.map((benefit, index) => (
                <Card
                  key={index}
                  className={`border-0 shadow-md h-full hover:shadow-lg transition-all duration-300 hover:translate-y-[-5px] ${benefitsInView ? "animate-fade-up" : "opacity-0"}`}
                  style={{ animationDelay: benefitsInView ? `${index * 100 + 200}ms` : "0ms" }}
                >
          ...
          <div className="container px-4 md:px-6">
            <div className={`mx-auto max-w-3xl text-center ${ctaInView ? "animate-fade-up" : "opacity-0"}`}>
              ...
              <p className="mb-8 text-gray-700 md:text-lg">
                Our team is ready to assist you with product information, pricing, and availability. Contact us today to
                learn more about our pharmaceutical products.
              </p>
